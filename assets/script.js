...
document.getElementById('simulation-form').addEventListener('submit', function(e) {
    ...
    console.log('Kepada: apricahyadi77@gmail.com');
    console.log('Dari:', name, `<${email}>`);
    console.log('Pesan:', message);
    console.log('=================================');
    
    alert(`Simulasi berhasil!\n\nData telah "dikirim" ke apricahyadi77@gmail.com.`);
    ...
    successMsg.innerHTML = '<p style="color: green; margin-top: 10px;">✓ Data telah disimulasikan untuk dikirim ke apricahyadi77@gmail.com</p>';
